...
export const ApOff = ({
  ...
  return (
    <SvgIcon size={size} color={color} className={className}>
      ...
      >
        <path
          d="M31 31H1V1H31V31ZM8.61719 4.06055L6.49512 6.18359L26.2949 25.9844L28.417 23.8633L8.61719 4.0625V4.06055Z"
          fill="white"
        />
      </mask>
      <g mask={`url(#${id})`}>
      ...
      <path
        d="M6.173 5.247 C 5.643 5.443,5.171 6.044,5.175 6.518 C 5.178 6.970,4.944 6.727,15.162 16.939 C 21.971 23.743,24.998 26.735,25.147 26.804 C 25.592 27.012,26.053 26.898,26.476 26.476 C 26.898 26.053,27.012 25.592,26.804 25.147 C 26.734 24.998,23.759 21.987,16.992 15.219 C 11.650 9.876,7.183 5.442,7.065 5.366 C 6.799 5.195,6.442 5.147,6.173 5.247 "
        fillRule="evenodd"
      />
    </SvgIcon>
  );
